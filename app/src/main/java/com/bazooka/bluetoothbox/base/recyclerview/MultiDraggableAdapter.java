package com.bazooka.bluetoothbox.base.recyclerview;
...
public abstract class MultiDraggableAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends BaseItemDraggableAdapter<T, K> {
     ...
     */
    public MultiDraggableAdapter(List<T> data) {
        super(data);
    }
