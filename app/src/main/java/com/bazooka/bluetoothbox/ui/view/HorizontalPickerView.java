...
public class HorizontalPickerView extends View {
    ...
    public HorizontalPickerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        centerRectPaint.setColor(0xff332b2b);
...
//        canvas.save();
//        canvas.drawRect(getWidth() / 2 - (int) itemClipBounds.width() / 2, 0, getWidth() / 2 + (int) itemClipBounds.width() / 2 , getHeight(), centerRectPaint);
//        canvas.restore();
        super.onDraw(canvas);
        ...
        switch (action) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (scrollingX ||
                    ...
                    if (leftEdgeEffect != null && rightEdgeEffect != null) {
...
//            postInvalidateOnAnimation(); // TODO
     ...
     * {@link HorizontalPickerView#getInBoundsX(int)}
     *
    ...
    private static final class Marquee extends Handler {
        ...
        private final WeakReference<HorizontalPickerView> mView;
        ...
        Marquee(HorizontalPickerView v, Layout l, boolean rtl) {
            ...
            mView = new WeakReference<HorizontalPickerView>(v);
        ...
        void tick() {
            ...
            final HorizontalPickerView view = mView.get();
    ...
    private static class PickerTouchHelper extends ExploreByTouchHelper {
        ...
        private HorizontalPickerView mPicker;

        public PickerTouchHelper(HorizontalPickerView picker) {
            super(picker);
            mPicker = picker;
        }
