...
public class ColorPickerView extends FrameLayout {
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        try {
            if (a.hasValue(R.styleable.ColorPickerView_paletteSrc)) {
                paletteDrawable = a.getDrawable(R.styleable.ColorPickerView_paletteSrc);
            }
            if (a.hasValue(R.styleable.ColorPickerView_selectorSrc)) {
                selectorDrawable = a.getDrawable(R.styleable.ColorPickerView_selectorSrc);
            }
        } finally {
            a.recycle();
        }
        ...
        if(getColor() != Color.TRANSPARENT) {
            ...
            if(event.getAction() == MotionEvent.ACTION_UP) {
                if(mColorListener != null) {
                    mColorListener.onTouchStop(getColor());
                }
            } else {
